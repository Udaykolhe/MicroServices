...
namespace Mango.Services.ProductAPI.Controllers
{
    ...
    public class ProductAPIController : ControllerBase
    {
        ...
        public ProductAPIController(AppDbContext db, IMapper mapper, ResponseDto response)
        {
            _db = db;
            _mapper = mapper;
            _response = response;
        ...
        public ResponseDto Post([FromBody] ProductDto productDto)
        {
            try
            {
                ...
                if (productDto != null)
                {
                    ...
                    string fileName = model.ProductId + Path.GetExtension(productDto.Image.FileName);
